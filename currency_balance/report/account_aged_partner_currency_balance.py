...
class ReportAgedPartnerCurrencyBalance(models.AbstractModel):
    ...
    _name = 'report.report_agedpartnercurrencybalance'
    ...
    def get_report_values(self, docids, data=None):
        ...
        movelines, total, dummy, currency_id, partner_id = self._get_partner_move_lines(account_type, date_from, target_move, data['form']['period_length'], data['form']['currency_id'], data['form']['direction_selection'], data['form']['partner'])
