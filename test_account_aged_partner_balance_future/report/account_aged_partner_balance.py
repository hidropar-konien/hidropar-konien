...
class ReportAgedPartnerBalance(models.AbstractModel):
    ...
    def _get_partner_move_lines_future(self, account_type, date_from, target_move, period_length, direction_selection='past', partner_id=False):
    ...
    def get_report_values(self, docids, data=None):
        ...
        movelines, total, dummy = self._get_partner_move_lines_future(account_type, date_from, target_move, period_length,
                                                               direction_selection, partner_id)
        return {
            'doc_ids': self.ids,
            'doc_model': model,
            'data': data['form'],
